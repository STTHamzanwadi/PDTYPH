...
public class GrafikJumlahDosenKelamin extends Panel implements View{
	/**
	 * 
	 */
	...
	public GrafikJumlahDosenKelamin() {
	...
	private Component buildHeader() {
		...
		titleLabel = new Label("Grafik Jumlah Pegawai Aktif Berdasarkan Jenis Kelamin");

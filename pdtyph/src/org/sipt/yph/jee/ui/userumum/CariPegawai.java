...
public class CariPegawai extends Panel implements View{
	...
	private Component getTable(){
		...
		tabel.setColumnHeader("nidn","NIDN");
		...
		tabel.setVisibleColumns("instansi","namaPegawai","jbtnStruktural","jbtnFungsional","alias","niy","nidn","nis","tempatLahir","tanggalLahir","agama","email","alamatRumah","nomorTelepon","nomorKtp","namaKepegawaian","statusKepegawaian","golongan","thnMasuk","jenjangPendTerakhir","prodiPendTerakhir","institusiPendTerakhir");

...
public class AdminMenuComponent extends CustomComponent {
	...
	private Component buildUserMenu() {
		Admin user=(Admin)VaadinSession.getCurrent().getAttribute(Admin.class);
		 final MenuBar settings = new MenuBar();
	        ...
	        settingsItem.addItem("Sign Out", new Command() {
	            @Override
	            public void menuSelected(MenuItem selectedItem) {
	                VaadinSession.getCurrent().setAttribute(Admin.class, null);
	...
	public class ValoMenuItemButton extends Button {
		...
		public ValoMenuItemButton(final AdminMenuItems view) {

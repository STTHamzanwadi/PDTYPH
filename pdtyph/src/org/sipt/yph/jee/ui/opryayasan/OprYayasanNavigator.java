...
public class OprYayasanNavigator extends Navigator {

    
    private final static OprYayasanMenuItems ERROR_VIEW = OprYayasanMenuItems.DASHBOARD;
    private ViewProvider errorViewProvider;

    public OprYayasanNavigator(ComponentContainer container) {
    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(ViewChangeEvent event) {
                for (OprYayasanMenuItems view : OprYayasanMenuItems.values()) {
